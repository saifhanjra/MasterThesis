# -*- coding: utf-8 -*-
"""
Created on Thu Feb 18 12:55:21 2016

@author: engrs
"""

import tester_adv_ex_cnn_cultivating

from tester_adv_ex_cnn_cultivating import Network
from tester_adv_ex_cnn_cultivating import ConvPoolLayer,ConvPoolLayer1, FullyConnectedLayer, SoftmaxLayer
training_data, validation_data, test_data = tester_adv_ex_cnn_cultivating.load_data_shared()


mini_batchsize=1
epislon=0.6 #### hyper parameter  used for the creation of adversial example
