# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 14:46:41 2016
...
#        
    ...
    def create_adversial_inpt(self,test_data,mini_batchsize,epislon):
            ...
            for i in xrange(len(self.index_correctly_classified)):
                ...
                if norm_grad_corr_classified_inpt>0.1:
                    ...
                    if pred_network_after==0:
                        ...
                        probability_wrongly_classified=self.check_confidence(mini_batchsize)
    ...
    def check_confidence(self,mini_batchsize):
        ...
        conf_corr_wrong=confidence(self.index_corr)
        return conf_corr_wrong
