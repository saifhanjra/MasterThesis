# -*- coding: utf-8 -*-
"""
Created on Mon Feb 15 12:40:15 2016

@author: engrs
"""

import tester_adv_ex_cnn_random_normal

from tester_adv_ex_cnn_random_normal import Network
from tester_adv_ex_cnn_random_normal import ConvPoolLayer,ConvPoolLayer1, FullyConnectedLayer, SoftmaxLayer
training_data, validation_data, test_data =tester_adv_ex_cnn_random_normal.load_data_shared()


mini_batchsize=1
epislon=0.30 #### hyper parameter  used for the creation of adversial example
