# -*- coding: utf-8 -*-
"""
Created on Fri Feb 26 13:09:35 2016
...
class Network(object):
    def __init__(self, layers, mini_batchsize):
        ...
        init_layer.set_inpt(self.x, self.x,self.mini_batchsize)
        for j in xrange(1, len(self.layers)):
            prev_layer, layer  = self.layers[j-1], self.layers[j]
            layer.set_inpt( prev_layer.output,prev_layer.output_dropout, self.mini_batchsize)
...
#            borrow=True)
    ...
    def set_inpt(self, inpt, inpt_dropout, mini_batchsize):
...
class FullyConnectedLayer(object):
    ...
    def set_inpt(self, inpt, inpt_dropout, mini_batchsize):
        ...
        self.inpt_dropout = dropout_layer(
            inpt_dropout.reshape((mini_batchsize, self.n_in)), self.p_dropout)
