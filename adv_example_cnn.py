# -*- coding: utf-8 -*-
"""
Created on Mon Feb 08 14:12:21 2016

@author: engrs
"""

import tester_adv_ex_cnn

from tester_adv_ex_cnn import Network
from tester_adv_ex_cnn import ConvPoolLayer,ConvPoolLayer1, FullyConnectedLayer, SoftmaxLayer
training_data, validation_data, test_data =tester_adv_ex_cnn.load_data_shared()
