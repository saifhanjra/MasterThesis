# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 13:29:59 2016

@author: engrs
"""
import tester_adv_ex_cnn_cultivating_and_epsilon_calc

from tester_adv_ex_cnn_cultivating_and_epsilon_calc import Network
from tester_adv_ex_cnn_cultivating_and_epsilon_calc import ConvPoolLayer,ConvPoolLayer1, FullyConnectedLayer, SoftmaxLayer
training_data, validation_data, test_data = tester_adv_ex_cnn_cultivating_and_epsilon_calc.load_data_shared()


mini_batchsize=1
epislon=0.25 #### hyper parameter  used for the creation of adversial example
