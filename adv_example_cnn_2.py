# -*- coding: utf-8 -*-
"""
Created on Thu May 12 13:14:13 2016

@author: engrs
"""

import tester_adv_ex_cnn_2

from tester_adv_ex_cnn_2 import Network
from tester_adv_ex_cnn_2 import ConvPoolLayer,ConvPoolLayer1, FullyConnectedLayer, SoftmaxLayer
training_data, validation_data, test_data =tester_adv_ex_cnn_2.load_data_shared()


mini_batchsize=1
epislon=0.1 #### hyper parameter  used for the creation of adversial example
