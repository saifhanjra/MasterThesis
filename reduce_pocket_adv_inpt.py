...
#            self.final_epislon_grad=[self.new_epislon_adv,self.norm_grad_list]
...
#        if self.pred_network_after==1:
#            while self.pred_network_after==1:
#                        
#                self.epislon_new=self.epislon_new+ 0.05*self.epislon_new
#                self.adv_inpt_assumed= self.f_test_inpt(self.index_corr)+self.epislon_new*(self.grad_correctly_classified_inpt/np.linalg.norm(self.grad_correctly_classified_inpt))
#                self.pred_network_after=self.appending_adv_inpt_and_check_equality(mini_batchsize)
#                print'step2: The value of new epislon is ', self.epislon_new
                
#        print 'step2 fininshed'
